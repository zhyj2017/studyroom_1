        ...
        <div class="col-sm-12 col-sm-offset-3">
            <div class="row">
                <div class="form-group" style="margin-top: 20px;  width:49%; ">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="请输入标题" style="font-family:serif;font-size:16px;" value="${notice.title}">
                </div>
                <div class="form-group" style="margin-top: 20px;  width:49%; ">
                    <label style="font-size: 16px">内容：</label><br/>
                    <textarea id="text" name="text" placeholder="请输入内容" cols="112" wrap="hard" style="font-family:serif;font-size:16px;width: 100%;height: 300px">${notice.text}</textarea>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-sm-offset-3">
