                ...
                <nav>
                    <ul class="pagination">
                        <li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>>
                            <a href="/students/search?start=0${page.param}&&id=${condition.id}&&name=${condition.name}&&cellphone=${condition.cellphone}&&dormitory=${condition.dormitory}" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>

                        <li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>>
                            <a href="/students/search?start=${page.start-page.count}${page.param}&&id=${condition.id}&&name=${condition.name}&&cellphone=${condition.cellphone}&&dormitory=${condition.dormitory}" aria-label="Previous">
                        ...
                        <c:forEach begin="0" end="${page.totalPage-1}" varStatus="status">
                            <c:if test="${status.count*page.count-page.start<=20 && status.count*page.count-page.start>=-10}">
                                <li <c:if test="${status.index*page.count==page.start}">class="disabled"</c:if>>
                                    <a href="/students/search?start=${status.index*page.count}${page.param}&&id=${condition.id}&&name=${condition.name}&&cellphone=${condition.cellphone}&&dormitory=${condition.dormitory}"
                        ...
                        <li <c:if test="${!page.hasNext}">class="disabled"</c:if>>
                            <a href="/students/search?start=${page.start+page.count}${page.param}&&id=${condition.id}&&name=${condition.name}&&cellphone=${condition.cellphone}&&dormitory=${condition.dormitory}" aria-label="Next">
                                <span aria-hidden="true">&rsaquo;</span>
                            </a>
                        </li>
                        <li <c:if test="${!page.hasNext}">class="disabled"</c:if>>
                            <a href="/students/search?start=${page.last}${page.param}&&id=${condition.id}&&name=${condition.name}&&cellphone=${condition.cellphone}&&dormitory=${condition.dormitory}" aria-label="Next">
